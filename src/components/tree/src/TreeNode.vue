  ...
  <div class="tree-node-container" >
    <ul :style="`padding-left:${showLine&&children&&children.length?20:8}px`">
      <li>
          ...
          >
          <img width="18" height="18" :src="imgSource[arrowType]" alt="" v-if="imgSource.right&&imgSource.down" />
          ...
          >
          <img width="18" height="18" class="label-icon" :src="children&&children.length?imgSource.node:imgSource.leaf" alt="" v-if="imgSource.node&&imgSource.leaf" />
...
export default {
  ...
  methods: {
    ...
    */
     ...
     */
    handleSelect() {
      if(!this.showCheckbox) this.dispatch("Tree", "on-select", this.nodeData);
    },
