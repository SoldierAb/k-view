...
"use strict";
/* harmony import */ var _locale_lang_zh_CN__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(14);
  ...
  inject: {
    kviewConfig: {
      default: function _default() {
        return {
          locale: _locale_lang_zh_CN__WEBPACK_IMPORTED_MODULE_0__["default"]
        };
      }
    }
  }
...
// CONCATENATED MODULE: ./src/utils/eventHandler.js
var Event = /*#__PURE__*/function () {
  function Event() {}

  Event.add = function add(t, eventName, cb) {
  ...
  Event.del = function del(t, eventName, cb) {
...
var drag_drag = function drag(el, downEl) {
  var _this2 = this;
  ...
  var maxLeft = width - clientWidth;
  var maxTop = height - clientHeight;
  el.style.position = "fixed";
  downEl.style.cursor = "move";

  var _el_cb = function _el_cb(ev) {
    var _this3 = this;

    _newArrowCheck(this, _this2);

    var e = ev || window.event;
    var posLeft = e.clientX - el.offsetLeft;
    var posTop = e.clientY - el.offsetTop;

    var _move_cb = function _move_cb(event) {
      _newArrowCheck(this, _this3);

      var _e = event || window.event;

      var curX = _e.clientX - posLeft;
      var curY = _e.clientY - posTop;
    ...
    var _del_move2 = function _del_move() {
      _newArrowCheck(this, _this3);

      Event.del(document, "mousemove", _move_cb);
      Event.del(document, "mouseup", _del_move2);
      downEl.style.cursor = "normal";
    }.bind(this);

    Event.add(document, "mousemove", _move_cb);
    Event.add(document, "mouseup", _del_move2);
    return false;
  }.bind(this);
...
/* harmony default export */ var utils_drag = __webpack_exports__["a"] = (drag_drag);
...
// EXTERNAL MODULE: ./src/utils/drag.js + 1 modules
var drag = __webpack_require__(46);

// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/components/fade-pop/src/FadePop.vue?vue&type=template&id=670c1652&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"fade-pop-container"},[_c('transition',{attrs:{"name":"fade-modal"}},[_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.modalShow),expression:"modalShow"}],staticClass:"fade-modal",on:{"click":_vm.modalClick}})]),_c('transition',{directives:[{name:"draggable",rawName:"v-draggable",value:(true),expression:"true"}],attrs:{"name":"fade-animate"},on:{"after-leave":_vm.afterLeave,"before-enter":function($event){_vm.modalShow = true}}},[(_vm.show)?_c('div',{staticClass:"fade-box",style:([_vm.fadeBoxStyle])},[_c('fade-body',[_c('div',{directives:[{name:"draggable",rawName:"v-draggable",value:(_vm.draggable),expression:"draggable"}],staticClass:"fade-head clearfix"},[_c('span',{staticClass:"fade-head-content"},[_vm._v(_vm._s(_vm.title))]),_c('span',{staticClass:"fade-head-close",on:{"click":_vm.closePop}},[_c('i',{staticClass:"el-icon-close"})])]),_c('div',{staticClass:"fade-body",style:(("height:calc(100% - " + ((_vm.footer?2:1)*48) + "px)"))},[_vm._t("default")],2),(_vm.footer)?_c('div',{staticClass:"fade-footer",style:(("justify-content:" + (typeof _vm.footer === 'string'?_vm.footer:'flex-end')))},[_vm._t("footer",[_c('k-button',{attrs:{"size":"small"},on:{"click":_vm.closePop}},[_vm._v("\n              "+_vm._s(_vm.kviewConfig.locale.k.fadePop.cancel)+"\n            ")]),_c('k-button',{attrs:{"size":"small","type":"primary"},on:{"click":function($event){return _vm.$emit('submit')}}},[_vm._v("\n              "+_vm._s(_vm.kviewConfig.locale.k.fadePop.confirm)+"\n            ")])])],2):_vm._e()])],1):_vm._e()])],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/fade-pop/src/FadePop.vue?vue&type=template&id=670c1652&

// EXTERNAL MODULE: ./node_modules/element-ui/lib/theme-chalk/button.css
var theme_chalk_button = __webpack_require__(84);

// EXTERNAL MODULE: ./node_modules/element-ui/lib/theme-chalk/base.css
var base = __webpack_require__(5);

// EXTERNAL MODULE: ./node_modules/element-ui/lib/button.js
var lib_button = __webpack_require__(60);
var lib_button_default = /*#__PURE__*/__webpack_require__.n(lib_button);

// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/components/fade-pop/src/FadeBody.vue?vue&type=template&id=0553a6d8&
var FadeBodyvue_type_template_id_0553a6d8_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"fade-body-container"},[_vm._t("default")],2)}
var FadeBodyvue_type_template_id_0553a6d8_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/fade-pop/src/FadeBody.vue?vue&type=template&id=0553a6d8&
...
var FadeBodyvue_type_style_index_0_lang_scss_ = __webpack_require__(86);
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  FadeBodyvue_type_template_id_0553a6d8_render,
  FadeBodyvue_type_template_id_0553a6d8_staticRenderFns,
  false,
  null,
  null,
  null
...
// EXTERNAL MODULE: ./src/mixins/inject.js
var inject = __webpack_require__(27);
...
/* harmony default export */ var FadePopvue_type_script_lang_js_ = ({
  ...
  components: {
    FadeBody: FadeBody,
    KButton: lib_button_default.a
  },
  mixins: [inject["a" /* default */]],
  model: {
    prop: "show",
    event: "change"
  },
...
var FadePopvue_type_style_index_0_lang_scss_ = __webpack_require__(87);
...
function fade_pop_newArrowCheck(innerThis, boundThis) { if (innerThis !== boundThis) { throw new TypeError("Cannot instantiate an arrow function"); } }




FadePop.install = function (Vue) {
  fade_pop_newArrowCheck(this, _this);

  Vue.directive("draggable", {
    inserted: function inserted(el, binding) {
      if (binding.value !== false) {
        Object(drag["a" /* default */])(el.parentNode.parentNode, el);
      }
    }
  });
